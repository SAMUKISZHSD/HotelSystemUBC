...
public class FuncionarioView {
    ...
    public void displayAllFuncionarios() {
        ...
        for (Funcionario funcionario : funcionarios) {
            ...
            System.out.println("ID Reservas: " + funcionario.getIdReservas());
            System.out.println("-----------------------------");
        }
    }
    ...
    public void addFuncionario() {
        ...
        System.out.println("Digite o ID das reservas:");
        int idReservas = scanner.nextInt();

        Funcionario funcionario = new Funcionario(id, nome, cargo, telefone, idReservas);
    ...
    public void updateFuncionario() {
        ...
        String telefone = scanner.nextLine();
        System.out.println("Digite o novo ID das reservas:");
        int idReservas = scanner.nextInt();
